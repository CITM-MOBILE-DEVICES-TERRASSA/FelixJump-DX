...
public class Score : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        {
            UnityEngine.Debug.LogError("No se encontr� una instancia de UpdateLobbyScore en la escena");
        }
    }
    ...
    private void InitializeScoreText()
    {
        ...
        {
            UnityEngine.Debug.LogWarning($"No se encontr� el objeto TextMeshProUGUI con el nombre '{scoreTextObjectName}'.");
        }
    }
}
*/